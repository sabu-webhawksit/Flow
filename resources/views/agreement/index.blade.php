 ...
 <div class="col-xs-12 no-padding-left-right">
    ...
    <div class="col-sm-12 custom-settings">
        <form class="form-horizontal" role="form">
          ...
          <div class="col-xs-12">
              <div class="form-group no-margin-left-right">
             <select id="agreement_type" name="agreement_type" class="form-control custom-form-control custom-form-control custom-form-control">
...
<div id="addAgreement" class="modal fade" role="dialog">
  <div class="modal-dialog custom-modal">
    ...
    <div class="modal-content">
      ...
      {!! Form::open(['url'=>url('add-agreement'),'class'=>'form-horizontal','role'=>'form'])!!}
