        ...
        <div class="row">
            <div class="col-sm-4 col-sm-offset-4 col-xs-12">
                ...
                <div class="login-body">
                        ...
                        @endif
                        <form role="form" action="{{ action('AuthController@postLogin') }}" method="post">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group custom-margin-left custom-margin-right">
                            <div class="input-group login-input-group">
                                <button class="btn btn-info btn-lg custom-info-btn login-btn"><i class="fa fa-unlock-alt"></i> Login</button>
                            </div>
                       </div>
                    </form>
                </div>
                ...
                <div class="login-footer">
                    ...
                    <center>
                        <a href="{{action('AuthController@getAccessRequest')}}">Request management access</a>
                    </center>
                </div> 
                <footer>
