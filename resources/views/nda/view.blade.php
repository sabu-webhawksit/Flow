 ...
 <div class="col-xs-12 no-padding-left-right">
    ...
    <div class="col-sm-12 custom-settings">
        <form class="form-horizontal" role="form">
          ...
          <div class="col-xs-12">
           <div class="form-group no-margin-left-right">
              <sapn class="form-control custom-form-control">{{$agreement->nda_type}}</span>
            </div>
          </div>
        </form>
        <div class="col-xs-12">
        ...
        <div class="col-xs-12">
          <div class="form-group no-margin-left-right">
            <a href="{{url('pdf-nda',$agreement->tms_id)}}" class="btn btn-default custom-btn" style="padding: 10px 21px;">Save as PDF</a>
        </div>
      </div>
    </div>
</div>
...
<div id="addAgreement" class="modal fade" role="dialog">
  <div class="modal-dialog custom-modal">
    ...
    <div class="modal-content">
      ...
      {!! Form::open(['url'=>url('update-nda'),'class'=>'form-horizontal','role'=>'form'])!!}
      <div class="modal-body">
        <div class="row">
            <div class="col-xs-12 col-sm-4">
               <div class="form-group no-margin-left-right">
                  <input type="text" class="form-control custom-form-control" name="agreement_title" value="{{$agreement->nda_type}}" placeholder="">
                </div>
            </div>
        </div>
        <div class="row">
          <div class="col-xs-12">
            <div class="form-group no-margin-left-right">
              <textarea class="form-control custom-form-control" rows="3" name="agreement_body" placeholder="Comments">{!!$agreement->nda_body!!}</textarea>
