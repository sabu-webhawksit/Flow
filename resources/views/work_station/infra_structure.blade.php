...
<div class="col-md-12 col-xs-11">
    <table class="table table-bordered custom-table">
        ...
        <tbody class="tableBody">
            ...
            <tr>
                <td>Windows
                    <input type="hidden" name="item[]" value="Windows"/>
                </td>
                <td>
                    <input type="text" name="qty[]" class="form-control"/>
                </td>
            ...
            <tr>
                <td>Tablet
                    <input type="hidden" name="item[]" value="Tablet"/>
                </td>
                <td>
                    <input type="text" name="qty[]" class="form-control"/>
                </td>
            ...
            <tr>
                <td>Headphone
                    <input type="hidden" name="item[]" value="Headphone"/>
                </td>
                <td>
                    <input type="text" name="qty[]" class="form-control"/>
                </td>
            ...
            <tr>
                <td>Mouse
                    <input type="hidden" name="item[]" value="Mouse"/>
                </td>
                <td>
                    <input type="text" name="qty[]" class="form-control"/>
                </td>
            ...
            <tr>
                <td>Keyboard
                    <input type="hidden" name="item[]" value="Keyboard"/>
            ...
            <tr>
                <td>UPS
                    <input type="hidden" name="item[]" value="UPS"/>
                </td>
                <td>
                    <input type="text" name="qty[]" class="form-control"/>
                </td>
            ...
            <tr>
                <td>AC 
                    <input type="hidden" name="item[]" value="AC"/>
            ...
            <tr>
                <td>Window Cover  
                    <input type="hidden" name="item[]" value="Window Cover"/>
                </td>
                <td>
                    <input type="text" name="qty[]" class="form-control"/>
                </td>
